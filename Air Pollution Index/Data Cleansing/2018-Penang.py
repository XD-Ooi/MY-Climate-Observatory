...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Seberang Jaya, PULAU PINANG",
                                      "Seberang Perai, PULAU PINANG",
                                      "Minden, PULAU PINANG",
                                      "Balik Pulau, PULAU PINANG"],
                        var_name="Station", value_name="API")
    area_directory = {"Seberang Jaya, PULAU PINANG": ("Seberang Jaya 2, Perai", "Pulau Pinang"),
                      "Seberang Perai, PULAU PINANG": ("Perai", "Pulau Pinang"),
                      "Minden, PULAU PINANG": ("USM", "Pulau Pinang"),
                      "Balik Pulau, PULAU PINANG": ("Balik Pulau", "Pulau Pinang")}
    ...
    df_final = df_final.drop(columns = ["Site","Station", "API"])  
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/ec49c297-d04f-4bd8-9d9a-5f5a650bff28/resource/316d7496-6f6a-4007-9dd5-884905404668/download/penang2018.xlsx"
    file_name = "API_Penang_2018.xlsx"
