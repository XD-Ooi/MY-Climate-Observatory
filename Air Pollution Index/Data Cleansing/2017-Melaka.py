...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Sek. Men. Keb. Seri Pengkalan, Alor Gajah",
                                      "Sek. Keb. Tanjung Minyak 2, Bukit Rambai",
                                      "Sekolah Tinggi Melaka, Bandaraya Melaka"],
                        var_name="Station", value_name="API")
    area_directory = {"Sek. Men. Keb. Seri Pengkalan, Alor Gajah": ("Alor Gajah", "Melaka"),
                      "Sek. Keb. Tanjung Minyak 2, Bukit Rambai": ("Bukit Rambai", "Melaka"),
                      "Sekolah Tinggi Melaka, Bandaraya Melaka": ("Bandaraya Melaka", "Melaka")}
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/b2088469-72d1-4323-9ae5-bef94e305ba5/resource/ae0cca30-93bb-4815-909c-2af6c88501f9/download/melaka.xlsx"
    file_name = "API_Melaka_2017.xlsx"
