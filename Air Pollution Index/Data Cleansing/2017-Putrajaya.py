...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Sek. Keb. Presint 18, Putrajaya"],
                        var_name="Station", value_name="API")
    area_directory = {"Sek. Keb. Presint 18, Putrajaya": ("Putrajaya","Wilayah Persekutuan")}
    ...
    df_final.to_csv(r"C:\Users\Xiandi\Desktop\Python\API_Putrajaya_2017_cleaned.csv")
    return df_final
    
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/7c8ea31e-716f-4ce2-bb71-bbfd64e56bb8/resource/c11e48e3-105a-4111-97ee-e7b7d16237e8/download/putrajaya.csv"
    file_name = "API_Putrajaya_2017.csv"
