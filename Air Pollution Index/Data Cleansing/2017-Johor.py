...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Klinik Kesihatan Bandar IOI, Segamat",
                                      "Kolej Vokasional Muar, Muar",
                                      "MRSM Batu Pahat, Batu Pahat",
                                      "Kolej Kejururawatan Kluang, Kluang",
                                      "Institut Perguruan Temenggong Ibrahim, Larkin",
                                      "Sek. Men. Pasir Gudang 2, Pasir Gudang",
                                      "Sek. Keb. Lepau, Pengerang",
                                      "Sek. Men. Agama Bandar Penawar, Kota Tinggi"],
    ...
    area_directory = {"Klinik Kesihatan Bandar IOI, Segamat": ("Segamat", "Johor"),
...
def main():
    url = "http://www.data.gov.my/data/en_US/dataset/4d92958e-84a6-4c3f-8a2a-5675abe868b3/resource/b3b7706b-98e0-435d-a924-48764e46a597/download/johor.csv"
    file_name = "API_Johor_2017.csv"
