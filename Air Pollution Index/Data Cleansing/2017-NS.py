...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Sek. Keb. Taman Semarak (Fasa 2), Nilai",
                                      "Sek. Men. Teknik Tuanku Jaafar, Seremban",
                                      "Pusat Sumber Pendidikan N. Sembilan, Port Dickson"],
                        var_name="Station", value_name="API")
    area_directory = {"Sek. Keb. Taman Semarak (Fasa 2), Nilai": ("Nilai", "Negeri Sembilan"),
                      "Sek. Men. Teknik Tuanku Jaafar, Seremban": ("Seremban", "Negeri Sembilan"),
                      "Pusat Sumber Pendidikan N. Sembilan, Port Dickson": ("Port Dickson", "Negeri Sembilan")}
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/a08686c5-90d0-4ec0-b79e-ea261aaae78d/resource/db5050c0-3328-4f69-9465-9731db44ac20/download/negeri-sembilan.xlsx"
    file_name = "API_NS_2017.xlsx"
