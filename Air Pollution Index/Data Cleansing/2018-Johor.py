...
def clean_data(file_name):
    ...
    df_final.to_csv(r"C:\Users\Xiandi\Desktop\Python\API_Johor_2018_cleaned.csv")
    return df_final
    
def main():
    url = "http://www.data.gov.my/data/en_US/dataset/4d92958e-84a6-4c3f-8a2a-5675abe868b3/resource/96bce2c4-fb60-4536-8452-b1cdadd94ba0/download/johor2018.xlsx"
    file_name = "API_Johor_2018.xlsx"
