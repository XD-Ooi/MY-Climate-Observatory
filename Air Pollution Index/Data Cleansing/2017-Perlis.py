...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Institut Latihan Perindustrian Kangar, Perlis"],
                        var_name="Station", value_name="API")
    area_directory = {"Institut Latihan Perindustrian Kangar, Perlis": ("Kangar", "Perlis")}
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/be1d0337-f7e2-4108-bed9-16528f4edb45/resource/f33941f7-8618-4189-8a15-1b4c33501697/download/perlis.xlsx"
    file_name = "API_Perlis_2017.xlsx"
