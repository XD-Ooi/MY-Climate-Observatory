...
Then, the data is organized to ease future analysis. Specific changes are as follows:
    ...
    4. Area and state organized in accordance to main dataset.
...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Sek. Keb. Batu Muda, Batu Muda",
                                      "Sek. Men. Keb. Seri Permaisuri, Cheras"],
                        var_name="Station", value_name="API")
    area_directory = {"Sek. Keb. Batu Muda, Batu Muda": ("Batu Muda,Kuala Lumpur","Wilayah Persekutuan"),
    ...
    df_final.to_csv(r"C:\Users\Xiandi\Desktop\Python\API_KL_2017_cleaned.csv")
    return df_final
    
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/eb399b56-28ee-4f29-b842-cb5617054df8/resource/9183d5ee-7781-41a4-86dd-81297de109f6/download/kuala-lumpur.csv"
    file_name = "API_KL_2017.csv"
