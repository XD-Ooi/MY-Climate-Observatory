...
def clean_data(file_name):
    ...
    df_final["Area"] = df_final["Area"].replace("Indera Mahkota Kuantan", "Indera Mahkota, Kuantan")
    df_final["Area"] = df_final["Area"].replace("Balok Baru Kuantan", "Balok Baru, Kuantan")
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/ccf86990-4052-4741-a0ea-23fc544a381c/resource/c7900925-d9e4-4bf9-9762-cc0b4b0650db/download/pahang2018.xlsx"
    file_name = "API_Pahang_2018.xlsx"
