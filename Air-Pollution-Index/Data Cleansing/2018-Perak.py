...
def clean_data(file_name):
    ...
    df_final = pd.melt(df_output, id_vars=["Datetime"], 
                        value_vars = ["Taiping, PERAK",
                                      "Tasek Ipoh, PERAK",
                                      "Pegoh Ipoh, PERAK",
                                      "Seri Manjung, PERAK",
                                      "Tanjung Malim, PERAK"],
                        var_name="Station", value_name="API")
    area_directory = {"Taiping, PERAK": ("Kg. Air Putih, Taiping", "Perak"),
                      "Tasek Ipoh, PERAK": ("Jalan Tasek, Ipoh", "Perak"),
                      "Pegoh Ipoh, PERAK": ("S K Jalan Pegoh, Ipoh", "Perak"),
                      "Seri Manjung, PERAK": ("Seri Manjung", "Perak"),
                      "Tanjung Malim, PERAK": ("Tanjung Malim", "Perak")}
...
def main():
    url = "http://www.data.gov.my/data/ms_MY/dataset/caae1f31-f80d-4952-bd7a-1b8ca4b58ec5/resource/6c5937f4-0016-4d78-bca9-db76d675e1f8/download/perak2018.xlsx"
    file_name = "API_Perak_2018.xlsx"
